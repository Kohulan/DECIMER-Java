...
public class TanimotoCalculator {
	...
	public static void main(String[] args) throws Exception {
		...
		String output_directory = "/path to output_directory/";

		File fileout = new File(output_directory + "TanimotoCDK_Predictions_.txt");

		if (!fileout.exists()) {
			fileout.createNewFile();
		}
		BufferedReader input_file = new BufferedReader(
				new FileReader(input_directory + "eval_predictions.txt"));
